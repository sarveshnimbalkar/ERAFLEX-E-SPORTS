...
const initialProducts: Product[] = [
  ...
  // Add more products to make the grid look full
  {
      id: "fb-3",
...
export default function Shop() {
  return (
    <main className="min-h-screen pt-32 pb-20 px-6 md:px-12 bg-brand-dark">
      <Header />
      
      <div className="max-w-7xl mx-auto space-y-16">
        <header className="space-y-4">
          <h1 className="font-display text-6xl md:text-8xl italic uppercase tracking-tighter">
            THE <span className="text-brand-accent">COLLECTIONS</span>
          </h1>
          <p className="font-indian text-gray-500 tracking-[0.4em] uppercase text-sm">
