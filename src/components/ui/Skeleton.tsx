...
export const CardSkeleton = () => (
  <div className="bg-brand-surface rounded-md border border-white/5 overflow-hidden">
...
export const StatSkeleton = () => (
  <div className="bg-brand-surface border border-white/5 p-6 rounded-md">
...
export const ProfileSkeleton = () => (
  <div className="space-y-8">
    <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
      <div className="bg-black/30 p-8 rounded-md border border-white/5 space-y-6">
      ...
      <div className="bg-black/30 p-8 rounded-md border border-white/5 space-y-4">
        <Skeleton className="h-3 w-24" />
